...
MINIMUM_TARGET_UTILIZATION: constant(uint256) = {{ MINIMUM_TARGET_UTILIZATION }}
MAXIMUM_TARGET_UTILIZATION: constant(uint256) = {{ MAXIMUM_TARGET_UTILIZATION }}  
FACTOR_PRECISION: constant(uint256) = 1000000000000000000  # 1e18

STARTING_INTEREST_PER_SECOND: constant(uint64) = {{ STARTING_INTEREST_PER_SECOND }}
MINIMUM_INTEREST_PER_SECOND: constant(uint64) = {{ MINIMUM_INTEREST_PER_SECOND }}
MAXIMUM_INTEREST_PER_SECOND: constant(uint64) = {{ MAXIMUM_INTEREST_PER_SECOND }} 
