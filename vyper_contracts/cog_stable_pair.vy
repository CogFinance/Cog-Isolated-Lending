...
MINIMUM_TARGET_UTILIZATION: constant(uint256) = 100000000000000000
MAXIMUM_TARGET_UTILIZATION: constant(uint256) = 650000000000000000  
FACTOR_PRECISION: constant(uint256) = 1000000000000000000  # 1e18

STARTING_INTEREST_PER_SECOND: constant(uint64) = 158548960
MINIMUM_INTEREST_PER_SECOND: constant(uint64) = 79274480
MAXIMUM_INTEREST_PER_SECOND: constant(uint64) = 7927448000 
